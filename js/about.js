...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const animatedElements = document.querySelectorAll('.story-section, .values-grid, .team-grid, .location-section, .cta-section');
    ...
    valueCards.forEach(card => {
        card.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 25px 50px rgba(139, 115, 85, 0.2), 0 0 30px rgba(139, 115, 85, 0.1)';
        });
